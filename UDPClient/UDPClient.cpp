...
int main()
{
    ...
    if (res != NO_ERROR)
    {
        cout << "WSAStartup ne ydalos s mistake " << res << endl;
        return 1;
    }
    ...
    {
        cout << "socket provalinsa s mistake " << WSAGetLastError() << endl;
        return 2;
    }  
    ...
    {
        cout << "recvfrom provalina s mistake " << WSAGetLastError() << endl;
        return 4;
    }

    receiveBuf[bytesReceived] = '\0';
    cout << "Polychen ot " << addrFrom.sin_addr.s_host << endl;
